  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        [
          'OS=="linux" and node_shared_v8=="false" and target_arch!="ppc" and target_arch!="ppc64" and target_arch!="s390" and target_arch!="s390x"', {
            'ldflags': [
      ...
      'targets': [
    {
      ...
      ], # end of standard node target
    }], # end of non-aix targets
