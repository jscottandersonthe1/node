...
quiet_cmd_solink_module = SOLINK_MODULE($(TOOLSET)) $@
cmd_solink_module = $(LINK.$(TOOLSET)) -Wl,-bM:sre -Wl,-bnoentry -Wl,-bexpfull -shared $(GYP_LDFLAGS) $(LDFLAGS.$(TOOLSET)) -o $@ $(filter-out FORCE_DO_CMD, $^) $(LIBS)
"""
...
cmd_copy = rm -rf "$@" && cp %(copy_archive_arguments)s "$<" "$@"
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  header_params = {
      ...
      'extra_commands': '',
      'srcdir': srcdir,
      'copy_archive_arguments': copy_archive_arguments,
    }
  if flavor == 'mac':
    ...
    # AIX's cp command does not support -af which is the default,
    #  so use -RPf which achives something similar
    header_params.update({
        'link_commands': LINK_COMMANDS_AIX,
        'flock': './gyp-flock-tool flock',
        'flock_index': 2,
        'copy_archive_arguments': '-R -P -f',
    })
